...
class TutorReportDialog extends StatefulWidget {
  const TutorReportDialog({Key? key, required this.token, required this.userId,}) : super(key: key);
  final String token;
  final String userId;
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      [
        ...
        TextButton(
          onPressed: _choices.contains(true) || _controller.text.isNotEmpty ? () async {
