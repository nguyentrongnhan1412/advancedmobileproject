...
class _TutorSearchResultState extends State<TutorSearchResult> {
  ...
  Future<void> _searchTutors(String accessToken, String name, bool isVietnamese, List<String> specialties,) async {
    ...
    return Scaffold(
      ...
      SingleChildScrollView(padding: const EdgeInsets.all(16), child: Column(
          ...
          children: [
            ...
            Text(
              _tutors.isEmpty ? 'No Match(es) Found' : 'Found $_count result(s)',
              ...
              children: [
                ...
                IconButton(
                  style: IconButton.styleFrom(
                    ...
                    backgroundColor: _page == 1 ? Colors.black : Colors.pink[300],
                  ),
                ...
                IconButton(
                  style: IconButton.styleFrom(
                    ...
                    backgroundColor: _page == _count ? Colors.black : Colors.pink[300],
                  ),
